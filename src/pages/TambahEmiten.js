...
export default function TambahEmiten() {
  ...
  function handleTambahDataEmiten(e) {
    e.preventDefault();
    // inisialisasi
      ...
      <div className="flex justify-center mt-3">
        <form action="" method="post" onSubmit={handleTambahDataEmiten}>
          ...
          <input
            ...
            className='block p-2 w-72 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
          ...
          <Heading Tag='h6' color='text-red-400'>{validation.nama_emiten}</Heading>
          {/* kode emiten */}
          ...
          <Heading Tag='h6' color='text-red-400'>{validation.kode_emiten}</Heading>
          {/* jumlah saham */}
          ...
          <Heading Tag='h6' color='text-red-400'>{validation.jumlah_saham}</Heading>
          <Button isPrimary type='submit' className='mt-3 w-72'>
